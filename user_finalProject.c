...
int rThreshold[6] = {2580,3140,1650,2150,990,1450}; //rLower, rUpper, gLower, gUpper, bLower, bUpper
int gThreshold[6] = {1800,2120,2300,2630,1000,1250}; //rLower, rUpper, gLower, gUpper, bLower, bUpper
int yThreshold[6] = {3300,3400,2750,3170,1100,1380}; //rLower, rUpper, gLower, gUpper, bLower, bUpper
int pThreshold[6] = {1620,1980,1520,1870,951,1280}; //rLower, rUpper, gLower, gUpper, bLower, bUpper
int oThreshold[6] = {3300,3400,1700,2230,1110,1500}; //rLower, rUpper, gLower, gUpper, bLower, bUpper
...
* Purple: R = [1620,1980]; G = [1520,1870]; B = [951,1280]
...
void main(void) {
	...
	P1DIR |= 0xD;   // Set Port 1 Pin 0 (P1.0), P1.2, P1.3 as an output.  Leaves Port1 pin 1 through 7 unchanged
